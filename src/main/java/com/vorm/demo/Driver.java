...
import com.vorm.util.Extractor;
...
public class Driver {
	...
	public static void main(String[] args) {
		...
		// The user might read the documentation and know to instantiate a Configuration
		// object

		// Step 1 of operations with the Configuration Object is adding the annotated
		// classes
...
//		cfg.getConnection("someUrl", "dbUsername", "dbPassword");
		...
		/**
		 * Printing MetaModel for class: com.vorm.model.Student Found a primary key
		 * field named id, of type int, which maps to the column with name: student_id
		 * Found a column field named name, of type class java.lang.String, which maps
		 * to the column with name: student_name
		 */
	}
}
